...
<body>
            ...
            <div class="left-title-flip flex">
                ...
                <div class="navlinks flex">
                    ...
                    <ul class="left-title flex fw-bold pt-1">
                        ...
                        <li class="min-scr active-nav"><a href="">Favourite</a></li>
                    </ul>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <div class="flex flex-column justify-content-between mt-3">
                    ...
                    <h1 class="my-3">Review Your Favorite Picks</h1>
                    <p id="favLength"></p>

                    <!-- cart container -->
                    <div id="favourite-list" class="favourite-container flex flex-column">
                        <!-- dynamic favorite items go here -->
                    </div>
                </div>
            </div>
        </section>
    ...
    <!-- favourite js -->
    <script src="assets/javaScript/favourite.js"></script>
</body>
</html>
