    ...
    <main id="main" class="menuMain">
        ...
        <section id="menu-container" class="flex">
            <section class="filter-sectionLeft p-3">
                ...
                <div class="flex price-rangeFilter mb-4 mt-2">

                    <div class="price-filter form-floating mb-3 me-1">
                        <input type="number" class="form-control" id="input1" placeholder="Minimum" />
                        <label for="input1">Minimum</label>
                    </div>

                    <div class="price-filter form-floating mb-3 ms-1">
                        <input type="number" class="form-control" id="input2" placeholder="Maximum" />
                        <label for="input2">Maximun</label>
                    </div>
            ...
            <section class="foodMenu-section p-3">
                ...
                <div class="productsSearch flex justify-content-between align-items-center mb-5">
                    <div class="product-search d-flex align-items-center">
        ...
        <footer class="w-100">
            ...
            <div class="footer-bottom">
                ...
                <hr>
                <div id="copyright" class="text-center">&copy;copyright <?php echo date("Y") ?> Developed by <a href="">jovinci</a></div>
            </div>
        </footer>
    </main>
